      ...
      <div className='md:w-[80vw] m-auto mt-6'>
        ...
        <div className='max-md:w-[80vw] m-auto border-2 border-text-color p-4 mt-6'>
          <form action="" method="post">
            <input className='my-2 w-full px-3 py-3 outline-orange-300' type="text" name="title" id="title" placeholder='Enter the Title of your Blog....' />
            <br />
            <input className='my-2 w-full px-3 py-3 outline-orange-300' type="text" name="title" id="title" placeholder='Tag Your Blog is related to...' />
            <br />
            ...
            <textarea className='w-full px-3 my-2 py-2 outline-orange-300' name="blogText" id="blogText" cols="30" rows="10" value={MarkdownText} onChange={(e) => { setMarkdownText(e.target.value) }}></textarea>
          </form>
        </div>
