    ...
    return (
        <>
            <div className='flex max-sm:flex-col justify-between w-[80vw] m-auto max-sm:mt-28'>
                <div className='font-Marmelad text-3xl text-text-color max-sm:mb-16'>Blog App</div>
                <div className='flex flex-col w-[60vw] h-[80vh] gap-36 font-light text-text-color'>
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className='flex flex-wrap justify-center w-max max-sm:flex-col gap-4 items-center'>
                            <input type="text" className='bg-gray-200 sm:px-5 px-2 min-[350px]:w-[300px] w-[200px] sm:py-3 py-1 rounded-md max-sm:mb-2 ' />
                            <div>
